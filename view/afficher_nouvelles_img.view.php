...
<html>
  ...
  <body>
    <?php foreach(array_reverse($idImages) as $id => $img){   // on affiche les nouvelles récentes d'abord (à noter que quand on ajoute un flux les plus récente sont à la fin, faute de mieux)?>
