...
<body>
    <?php foreach($idImages as $id => $img){   // on affiche les nouvelles récentes d'abord (à noter que quand on ajoute un flux les plus récente sont à la fin, faute de mieux)?>
        <a
		href="<?php echo 'http://www-etu-info.iut2.upmf-grenoble.fr/~deslotl/ProgWeb/Projet-Web-s3/controler/afficher_nouvelle.ctrl.php?id_Nouvelle='.$img?>">
		<img
		src="<?php echo 'http://www-etu-info.iut2.upmf-grenoble.fr/~deslotl/ProgWeb/Projet-Web-s3/model/images/'.$img.'.jpg'?>"
